...
void emberAfPluginBleSecurityManagerConfigureCommand(void);
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginBleSmConfigureCommandArguments[] = {
...
static EmberCommandEntry emberCommandPluginBleSmTable[] = {
  emberCommandEntryActionWithDetails("configure", emberAfPluginBleSecurityManagerConfigureCommand, "uu", "Configure security requirements and I/O capabilities of the system; Se ...", pluginBleSmConfigureCommandArguments),
  emberCommandEntryActionWithDetails("delete-all-bondings", emberAfPluginBleSecurityManagerDeleteAllBondingsCommand, "", "Delete all bondings; See https://docs.silab ...", NULL),
  emberCommandEntryActionWithDetails("delete-bonding", emberAfPluginBleSecurityManagerDeleteBondingCommand, "u", "Delete bonding; See https://docs.silab ...", pluginBleSmDeleteBondingCommandArguments),
  emberCommandEntryActionWithDetails("increase-security", emberAfPluginBleSecurityManagerIncreaseSecurityCommand, "u", "Increase the security level; See https://docs.silab ...", pluginBleSmIncreaseSecurityCommandArguments),
  emberCommandEntryActionWithDetails("list-all-bondings", emberAfPluginBleSecurityManagerListAllBondingsCommand, "", "Send a command to get all the current bondings; See https://doc ...", NULL),
  emberCommandEntryActionWithDetails("set-bondable-mode", emberAfPluginBleSecurityManagerSetBondableModeCommand, "u", "Set the bondable mode; See https://docs.silab ...", pluginBleSmSetBondableModeCommandArguments),
  emberCommandEntryTerminator(),
};
